...
async def get_user_friends(
    page_index: int, user_id: int, page_size: Optional[int] = 10
):
    return {
        "page info": f"page_index={page_index}, user_id={user_id}, page_size={page_size}"
    }
...
async def get_students(
    ...
    return {
        "page info": f"page_index={page_index}, page_size={page_size}, sort_by={sort_by}"
    }
